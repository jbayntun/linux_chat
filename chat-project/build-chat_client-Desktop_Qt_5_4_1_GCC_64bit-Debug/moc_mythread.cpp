...
#include "../chat_client/mythread.h"
...
QT_MOC_LITERAL(4, 31, 11), // "userChanged"
QT_MOC_LITERAL(5, 43, 17) // "connectionDropped"

    },
    "MyThread\0valueChanged\0\0message\0"
    "userChanged\0connectionDropped"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->userChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->connectionDropped(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::valueChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (MyThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::userChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (MyThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::connectionDropped)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void MyThread::valueChanged(QString _t1)
{
...
// SIGNAL 1
void MyThread::userChanged(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void MyThread::connectionDropped()
{
